*How to make a private Epstein files search engine - now updated to add AI - Claude command line agentic search and a prototype web UI*
...
© 2026 Dan Neidle, with Claude/AI elements contributed by SH. 
